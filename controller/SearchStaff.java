...
public class SearchStaff extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Staff staff = staffService.findStaffID(id);

            session.setAttribute("staff", staff);
            if (button.equals("Delete")) {
                response.sendRedirect(request.getContextPath() +"/backEnd/Staff/Done/DeleteStaff.jsp");
            } else {
                response.sendRedirect(request.getContextPath() +"/backEnd/Staff/Done/UpdateStaff.jsp");
            }
